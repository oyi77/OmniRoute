...
| File                             | Lines | Purpose                               |
| -------------------------------- | ----- | ------------------------------------- |
| `src/lib/plugins/marketplace.ts` | 202   | Marketplace data + API                |
| `src/lib/plugins/manager.ts`     | 568   | Install/activate/deactivate lifecycle |
| `src/lib/plugins/loader.ts`      | 326   | Plugin loading and validation         |
| `src/lib/plugins/manifest.ts`    | 213   | Manifest schema validation            |
