...
import { createDraftId, createEmptyCaseDraft } from "./draft-helpers";
import type { BuilderStrategy, EvalCaseDraft, EvalSuiteDraft, TranslateFn } from "./types";

export function SuiteBuilderModal({
  draft,
  isOpen,
  onChange,
  onClose,
