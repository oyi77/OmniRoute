...
export function renderKindPanel(kind: ServiceKind, providerId: string): JSX.Element | null { switch (kind) {
  case "llm":
...
export function ProviderPlaygroundPanel({ providerId }: { providerId: string }) { // Resolve serviceKinds from AI_PROVIDERS.
